...
function createSystemConfigsTable() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        `);
            ...
            for (const config of configs) {
                try {
                    yield (0, db_1.query)(`INSERT INTO system_configs (category, key, value, data_type, description)
                     VALUES ($1, $2, $3, $4, $5)
                     ON CONFLICT (category, key) DO UPDATE
                     SET value = EXCLUDED.value,
                         description = EXCLUDED.description,
                         updated_at = CURRENT_TIMESTAMP`, [config.category, config.key, config.value, config.data_type, config.description]);
...
exports.default = createSystemConfigsTable;
