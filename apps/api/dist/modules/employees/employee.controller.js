...
class EmployeeController {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (usePagination) {
                    ...
                    const result = yield employee_service_1.default.getEmployeesPaginated(paginationParams, filters, sortParams.field, sortParams.order);
                    res.json(result);
                }
                else {
    ...
    getEmployeeById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                const employee = yield employee_service_1.default.getEmployeeById(id);
                if (!employee) {
    ...
    createEmployee(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const employee = yield employee_service_1.default.createEmployee(employeeData);
    ...
    updateEmployee(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const employee = yield employee_service_1.default.updateEmployee(updateData);
                res.json(employee);
            }
            catch (error) {
    ...
    deleteEmployee(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                yield employee_service_1.default.deleteEmployee(id);
    ...
    getEmployeeManager(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                const manager = yield employee_service_1.default.getManager(id);
                if (!manager) {
    ...
    getEmployeeDirectReports(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                const directReports = yield employee_service_1.default.getDirectReports(id);
