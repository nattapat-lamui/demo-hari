...
router.post("/forgot-password", security_1.forgotPasswordLimiter, security_1.validateForgotPassword, security_1.validateRequest, AuthController_1.default.forgotPassword.bind(AuthController_1.default));
// POST /api/auth/reset-password - Reset password with token
router.post("/reset-password", security_1.authLimiter, security_1.validateResetPassword, security_1.validateRequest, AuthController_1.default.resetPassword.bind(AuthController_1.default));
// POST /api/auth/refresh - Refresh access token (no auth required — token is expired)
router.post("/refresh", security_1.authLimiter, AuthController_1.default.refresh.bind(AuthController_1.default));
