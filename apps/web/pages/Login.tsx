            ...
            <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className={`w-full bg-primary text-white py-2.5 rounded-lg font-medium hover:bg-primary-dark transition-colors shadow-sm ${loading ? 'opacity-70 cursor-not-allowed' : ''
                            }`}
                    >
